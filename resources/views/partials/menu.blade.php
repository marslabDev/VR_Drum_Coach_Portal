<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('assignment_management_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/assignments*") ? "c-show" : "" }} {{ request()->is("admin/submissions*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
        ...
        @endcan
        @can('attendence_management_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/attendences*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.attendenceManagement.title') }}
                </a>
                <ul class="c-sidebar-nav-dropdown-items">
                    @can('attendence_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.attendences.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/attendences") || request()->is("admin/attendences/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">

                                </i>
                                {{ trans('cruds.attendence.title') }}
                            </a>
                        </li>
                    @endcan
                </ul>
