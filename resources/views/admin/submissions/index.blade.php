                ...
                <tr>
                    ...
                    <td>
                        <select class="search" strict="true">
                            <option value>{{ trans('global.all') }}</option>
                            @foreach(App\Models\Submission::STATUS_SELECT as $key => $item)
...
{ data: 'id', name: 'id' },
{ data: 'assignment_title', name: 'assignment.title' },
{ data: 'assignment.student_efk', name: 'assignment.student_efk' },
{ data: 'assignment.deadline', name: 'assignment.deadline' },
