...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.attendence.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.attendences.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="student_efk">{{ trans('cruds.attendence.fields.student_efk') }}</label>
                <input class="form-control {{ $errors->has('student_efk') ? 'is-invalid' : '' }}" type="text" name="student_efk" id="student_efk" value="{{ old('student_efk', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('attended_at') ? 'is-invalid' : '' }}" type="text" name="attended_at" id="attended_at" value="{{ old('attended_at') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('leave_at') ? 'is-invalid' : '' }}" type="text" name="leave_at" id="leave_at" value="{{ old('leave_at') }}" required>
