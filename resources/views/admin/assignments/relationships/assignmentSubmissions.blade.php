...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-assignmentSubmissions">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.submission.fields.assignment') }}
                        </th>
                        <th>
                ...
                <tbody>
                    @foreach($submissions as $key => $submission)
                        <tr data-entry-id="{{ $submission->id }}">
                            ...
                            <td>
                                {{ $submission->assignment->student_efk ?? '' }}
                            </td>
                            <td>
...
@endcan
  ...
  let table = $('.datatable-assignmentSubmissions:not(.ajaxTable)').DataTable({ buttons: dtButtons })
