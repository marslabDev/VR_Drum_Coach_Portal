    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.assignments.update", [$assignment->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('student_efk') ? 'is-invalid' : '' }}" type="number" name="student_efk" id="student_efk" value="{{ old('student_efk', $assignment->student_efk) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('coach_efk') ? 'is-invalid' : '' }}" type="number" name="coach_efk" id="coach_efk" value="{{ old('coach_efk', $assignment->coach_efk) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('instructions') ? 'is-invalid' : '' }}" name="instructions" id="instructions">{!! old('instructions', $assignment->instructions) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('start_at') ? 'is-invalid' : '' }}" type="text" name="start_at" id="start_at" value="{{ old('start_at', $assignment->start_at) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lesson_time_efk') ? 'is-invalid' : '' }}" type="number" name="lesson_time_efk" id="lesson_time_efk" value="{{ old('lesson_time_efk', $assignment->lesson_time_efk) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('deadline') ? 'is-invalid' : '' }}" type="text" name="deadline" id="deadline" value="{{ old('deadline', $assignment->deadline) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('time_given') ? 'is-invalid' : '' }}" type="number" name="time_given" id="time_given" value="{{ old('time_given', $assignment->time_given) }}" step="1">
